...
def get_method_statement(string):
    ...
    if len(chunck_start_poss) > 1:
        # for each code chunck tokens sequence
        # between two positionmarkers. get the source code chuncks
        ...
        # get the last code statement, but remove the last token which is the closing bracket
